...
export function contributionsCard({ contrib }) {
  ...
  const body =
    ...
    + `<text x="48" y="34" font-family="Geist,Inter,system-ui,sans-serif" font-size="10.5" `
    + `fill="${PALETTE.dim}" letter-spacing="4.6">CONTRIBUTION FIELD ／ 貢献 ／ 53 WEEKS</text>`
    + `<path d="M48 44h804" stroke="${PALETTE.rule}"/>`
    + `<g font-family="'IBM Plex Mono',ui-monospace,Menlo,Consolas,monospace" font-size="11" `
    + `font-weight="700" fill="${PALETTE.mint}" text-anchor="middle">${tiers(buckets)}</g>`
    + `<text x="852" y="34" text-anchor="end" font-family="Geist,Inter,system-ui,sans-serif" `
